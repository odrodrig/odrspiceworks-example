...
`date time filter`|`object`| Fields: `closed_at`, `created_at`, `due_at`, `status_updated_at`, `viewed_at`, See [Date Time Range](/docs/CanvasAppApis.md#DateTimeFiltering) documentation for more information.
