...
`date time filter`|`object`| Fields: `offline_at`, `online_at`, `last_scanned_at`, See [Date Time Filtering](/docs/CanvasAppApis.md#datetimefiltering) documentation for more information.
